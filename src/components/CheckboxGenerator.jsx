...
const CheckboxGenerator = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto min-h-screen bg-[#F9FAFB] font-manrope px-4 sm:px-6 py-8">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                    <div className="px-4 py-2 bg-[#FFFFFF] rounded-lg border border-[#E5E7EB]">
                        ...
                        <span className="font-bold text-[#3B82F6]">{checkboxDesigns.length}</span>
                    </div>
            ...
            {currentItems.length > 0 ? (
                ...
                <div className="min-h-125 flex items-center justify-center bg-[#FFFFFF] rounded-xl border border-[#E5E7EB]">
                    <p className="text-[#6B7280]">No checkbox designs found</p>
                </div>
            )}
